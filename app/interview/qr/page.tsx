...
export default function InterviewQRPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-pink-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Generate Interview QR</h1>
          <p className="text-lg text-gray-600">
            Create a QR code that links directly to Interview Mode for fast, on-site dream collection.
          </p>
          <div className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-full bg-white/80 border">
            <Calendar className="h-4 w-4" aria-hidden="true" /> {EVENT_DATE_DISPLAY} • {EVENT_TIME_DISPLAY}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <QrCode className="h-5 w-5" aria-hidden="true" /> Generate Interview QR
            </h2>
            <div className="space-y-4">
              <div>
                <label htmlFor="stationCode" className="block text-sm font-medium text-gray-700 mb-1">Station Code</label>
                <input
                  id="stationCode"
                  value={stationCode}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <MapPin className="h-4 w-4 text-gray-400 absolute left-3 top-1/2 -translate-y-1/2" aria-hidden="true" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="volunteerId" className="block text-sm font-medium text-gray-700 mb-1">Volunteer ID (optional)</label>
                  <input
                    id="volunteerId"
                    value={volunteerId}
                ...
                <div className="mt-4 text-center">
                  ...
                  <div className="mt-3 space-x-3">
                    ...
                    <a href={result.url} target="_blank" rel="noopener" className="inline-flex items-center gap-2 px-4 py-2 rounded bg-white border hover:bg-gray-50">
                      <Link2 className="h-4 w-4" aria-hidden="true" /> Open Interview
                    </a>
                  </div>
