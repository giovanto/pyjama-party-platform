...
- main:
  ...
  - textbox "Which train station? *": Vienna Central Station
  - text: City *
  - textbox "City *": Vienna
  - text: Country *
  - textbox "Country *": Austria
  - text: Your name (as organizer) *
  - textbox "Your name (as organizer) *": Test Organizer
  - text: Email for coordination (optional)
  - textbox "Email for coordination (optional)": organizer@example.com
  ...
  - textbox "Describe your pyjama party plan *": Vienna pyjama party test
