...
- main:
  ...
  - textbox "Which train station? *": Paris Nord
  - text: City *
  - textbox "City *": Paris
  - text: Country *
  - textbox "Country *": France
  - text: Your name (as organizer) *
  - textbox "Your name (as organizer) *": Test Organizer
  - text: Email for coordination (optional)
  - textbox "Email for coordination (optional)": invalid-email
  ...
  - textbox "Describe your pyjama party plan *": Paris pyjama party
