...
- main:
  ...
  - textbox "Which train station? *": Berlin Hauptbahnhof
  - text: City *
  - textbox "City *": Berlin
  - text: Country *
  - textbox "Country *": Germany
  - text: Your name (as organizer) *
  - textbox "Your name (as organizer) *": Test User
  - text: Email for coordination (optional)
  - textbox "Email for coordination (optional)": test@example.com
  - paragraph: "Optional: You'll receive Discord invite, Party Kit, and coordination updates if provided"
  - paragraph: A pyjama party is already organized for this station on this date
  - text: How many people do you expect?
  - spinbutton "How many people do you expect?": "15"
  - text: Describe your pyjama party plan *
  - textbox "Describe your pyjama party plan *": Test pyjama party for E2E testing
