...
- main:
  ...
  - text: 20 Dream Routes 8 Active Dreamers
  - heading "Campaign Progress" [level=3]
  - text: Dream Routes 20 / 1000 Active Dreamers 8 / 500 Pajama Parties 8 / 50
  - heading "Most Wanted Routes" [level=3]
  - text: Berlin → Vienna 5 Paris → Madrid 3 Amsterdam → Rome 2
  - heading "Recent Activity" [level=3]
  - text: 💭 New dream route Berlin Hauptbahnhof → Vienna Central just now 💭 New dream route Amsterdam Centraal → Barcelona Sants just now 💭 New dream route Rome Termini → Naples Central just now 🎉 Pajama party Test Station Berlin 1753192415362 18m ago 🎉 Pajama party Update Test Station 19m ago
